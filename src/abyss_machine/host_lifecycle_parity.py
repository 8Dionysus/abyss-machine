...
RUNTIME_COMMANDS: dict[str, tuple[str, ...]] = {
    ...
    "storage-paths": ("abyss-machine", "storage", "paths", "--json"),
    "storage-cleanup-plan": ("abyss-machine", "storage", "cleanup-plan", "--json"),
...
RUNTIME_COMMAND_EFFECTS: dict[str, str] = {
    ...
    "storage-paths": "read_only",
    "storage-cleanup-plan": "refresh_latest",
