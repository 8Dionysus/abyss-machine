...
`tests/public_smoke` protects public bootstrap and publication boundaries.
`tests/host_contract` preserves imported workstation contract pressure for
development and migration work.
