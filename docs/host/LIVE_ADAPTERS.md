...
1. Storage/process/memory/mode/cooling adapters: continue with concrete
   ...
   first mode mutation adapter. Continue with remaining mode live sampling,
   cooling writes, or hotpath execution only when the fakeable live port is
   clear. Keep
