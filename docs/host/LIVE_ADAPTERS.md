...
dictation postprocess/notification glue. Those remain explicit live adapter
...
The CLI still owns postprocess glue, notification flow, and command rendering.
...
2. Dictation and AI runtime adapters: dictation postprocess/notification glue
   and AI runtime subprocess plans.
