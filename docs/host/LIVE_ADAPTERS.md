...
2. Self-awareness live orchestration adapters: latest-read specs/load dispatch,
   ...
   working-stack model/tool bridge policy, probe/cycle
   ...
   assembly, cycle chain assembly through supplied completion predicates,
   cycle post-export chain updates, cycle stack-handoff summary document
   assembly, and cycle partial/building/final result document assembly now live
   in `self_awareness_adapters`; split remaining
