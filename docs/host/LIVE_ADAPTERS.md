...
2. Self-awareness live orchestration adapters: latest-read specs/load dispatch,
   ...
   orchestration, complete status latest/body/open-row assembly, and complete
   probe/cycle preflight/refresh/proof/
   ...
   artifact/freshness binding only when the next fakeable live port proves a
