...
focused-browser, browser-privacy, browser-context, and AT-SPI probes remain live
edge debt.
...
selftest execution, GI/Atspi frame focus, release-profile probing,
focused-browser diagnostics, and privacy selftest record readers remain live
edge debt.
...
1. Typing/nervous source adapters: browser AT-SPI selftest execution,
   ...
   selftest record readers, and GI/Atspi frame focus runtime edge.
