...
gate binding, STT fixture generation, token-accounting live text/env binding,
resident LLM parser/result rendering, workhorse result rendering, broader
resource sampling, and live input collection for the core AI readmodels.
