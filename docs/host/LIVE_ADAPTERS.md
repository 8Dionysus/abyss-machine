...
status/latest/resource/artifact input collection, completion drilldowns, route
maps, entity-event-document maps, route-packet assembly, final audit document
assembly, latest/history persistence, and rendering. Public tests constrain
gate/blocker identity, owner routing, action order, fallback evidence refs, and
no-execution policy; live closeout compares compact gate states, blocker IDs,
top action identity/priority, route/entity/packet counts, and history delta.
...
2. Self-awareness live orchestration adapters: latest-read specs/load dispatch,
   ...
   completion drilldown/route/entity/packet assembly and completion-audit
