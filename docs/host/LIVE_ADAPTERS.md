...
1. AI runtime adapters: broader resource sampling and any remaining resident
   ...
   store/readmodel routing, resident and workhorse LLM controller execution, the TTS client/server-loop/warm-runtime/
