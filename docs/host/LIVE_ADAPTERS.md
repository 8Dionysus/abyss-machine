...
1. Storage/process/memory/mode/cooling adapters: continue with concrete
   ...
   first mode mutation/reconcile adapters and cooling host-control adapter.
   Continue with cooling validation/apply orchestration or hotpath execution
