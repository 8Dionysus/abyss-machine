...
selftest execution, URL-scanned text insertion, GI/Atspi frame focus,
...
1. Typing/nervous source adapters: browser AT-SPI selftest execution,
   ...
   selftest record readers, URL-scanned AT-SPI text insertion, and GI/Atspi
   frame focus runtime edge.
