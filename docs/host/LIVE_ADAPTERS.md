...
2. Self-awareness live orchestration adapters: latest-read specs/load dispatch,
   ...
   handoff route builders/completion predicates, working-stack model/tool bridge policy, probe/cycle
