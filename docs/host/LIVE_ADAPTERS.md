...
status/latest/resource/artifact input collection, entity-event-document maps,
route-packet assembly, final audit document
assembly, latest/history persistence, and rendering. Public tests constrain
...
2. Self-awareness live orchestration adapters: latest-read specs/load dispatch,
   ...
   two-stage-persistence orchestration also live there. Split remaining
   completion entity/packet graph assembly and completion-audit
