...
2. Self-awareness live orchestration adapters: latest-read specs/load dispatch,
   ...
   activation-entry predicates, working-stack model/tool bridge policy, probe/cycle
