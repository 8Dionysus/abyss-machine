...
## Extracted Editor Callback Runtime Seam

`abyss_machine.typing_editor_adapters` owns the VS Code editor callback
selftest runtime boundary for typing intake:
...
file write port, recent-record finder, cleanup implementation,
latest/history/index store binding, and command rendering.
