...
writes, process container/podman probes, desktop/AT-SPI/DBus/window probes,
thermal attribution/plan orchestration, and rendering.
...
1. Storage/process/memory/mode/cooling adapters: continue with concrete
   ...
   adapters, such as deeper process/container live probes,
