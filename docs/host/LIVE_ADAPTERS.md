...
status/latest/resource/artifact input collection, route-packet and final audit
...
empty state, unresolved bridge documents, and no-execution policy. Live
closeout compares only compact counts, IDs, unmapped sets, readiness booleans,
...
2. Self-awareness live orchestration adapters: latest-read specs/load dispatch,
   ...
   `self_awareness_completion_graph_contracts`. Split remaining completion
   route-packet/final-audit assembly and completion-audit
