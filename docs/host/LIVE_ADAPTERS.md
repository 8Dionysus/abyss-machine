...
selftest latest/index writes, callback binding, and command rendering.
Focused-browser, browser-privacy, and AT-SPI probe execution remain live edge
debt.
...
selftest execution, focused-browser diagnostics, and
privacy live-probe orchestration remain live edge debt.
...
1. Typing/nervous source adapters: browser AT-SPI selftest execution,
   focused-browser and privacy selftest runtime adapters.
