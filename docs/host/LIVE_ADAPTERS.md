...
2. Self-awareness live orchestration adapters: latest-read specs/load dispatch,
   ...
   working-stack inventory assembly/readmodel, working-stack model/tool bridge
   policy, probe/cycle
