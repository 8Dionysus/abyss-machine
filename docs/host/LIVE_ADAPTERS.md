...
1. AI runtime adapters: broader resource sampling and any remaining resident
   ...
   execution plus token-accounting store/readmodel routing, resident LLM
   controller execution, the TTS client/server-loop/warm-runtime/
