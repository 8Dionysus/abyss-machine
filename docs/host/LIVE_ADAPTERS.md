...
1. AI runtime adapters: any remaining resident LLM readmodel/write orchestration
   ...
   store/readmodel routing, capabilities input collection, policy input
   collection, resource snapshot/profile assembly, subprocess env binding,
   resident and workhorse LLM controller execution, STT eval
