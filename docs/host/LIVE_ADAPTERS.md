...
2. Self-awareness live orchestration adapters: latest-read specs/load dispatch,
   ...
   assembly, working-stack link-integrity matrix assembly plus match/freshness
   predicates, autolink row-state/completion/episode-coverage and
   activation-entry predicates, activation-smoke and stack-organ-use
