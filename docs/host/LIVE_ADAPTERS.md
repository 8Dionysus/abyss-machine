...
rendering, broader resource sampling, non-workload remaining latest/history
writes, and AI report assembly.
...
1. AI runtime adapters: broader resource sampling and any remaining resident
   ...
   store/readmodel write routing, token-accounting tokenizer execution,
