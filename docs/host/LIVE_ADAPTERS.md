...
command rendering. Browser-history capture remains a separate
nervous-local capture debt.

## Extracted Nervous Browser-Content Store, AT-SPI, And BiDi Capture Seam
...
Firefox WebDriver BiDi/WebSocket capture runtime:
...
source-policy/privacy decisions, browser-history capture execution, capture
orchestration, and command rendering. Browser-history capture execution remains
a separate nervous-local adapter debt.
