...
2. Self-awareness live orchestration adapters: latest-read specs/load dispatch,
   ...
   `self_awareness_adapters`; complete probe preflight/request/event/refresh/
   validation/two-stage-persistence orchestration also lives there. Split
   remaining cycle orchestration, concrete artifact/freshness binding, and deeper runtime
