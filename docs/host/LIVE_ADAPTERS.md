...
1. Storage/process/memory/mode/cooling adapters: continue with concrete
   ...
   first mode mutation/reconcile adapters and cooling host-control/TFN orchestration adapter.
   Continue with RAPL smoothing decision/state orchestration or hotpath execution
