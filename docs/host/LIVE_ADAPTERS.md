...
1. Storage/process/memory/mode/cooling adapters: continue with concrete
   ...
   Continue with cooling live sampling/validation orchestration or hotpath
   execution only when the fakeable live port is
   clear. Keep
