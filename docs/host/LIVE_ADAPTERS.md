...
2. Self-awareness live orchestration adapters: latest-read specs/load dispatch,
   ...
   events/collect/index persistence plus replay latest-read/checkpoint-chain
   validation/readmodel persistence now live in
   `self_awareness_adapters`; split remaining
   probe/cycle/investigate execution, concrete artifact/freshness
   binding, and deeper runtime
