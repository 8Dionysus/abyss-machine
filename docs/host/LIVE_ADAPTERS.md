...
broader resource sampling, and live input collection for the core AI readmodels.
...
1. AI runtime adapters: broader resource sampling and any remaining resident
   ...
   store/readmodel routing, resident LLM controller execution, the TTS client/server-loop/warm-runtime/
