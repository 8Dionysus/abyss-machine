...
- updateable/installable artifacts pass the OS Abyss TUF-style metadata gate
  and an artifact `trust-gate` verdict before update-client consumption; a full
  external TUF repository and SCITT transparency service remain separate future
  production layers;
