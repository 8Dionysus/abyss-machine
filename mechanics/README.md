...
- `typing-intake`: typing latest/history persistence, Codex session-tail
  ...
  planning/response envelopes, temporary Firefox WebExtension selftest runtime,
  AT-SPI focused/text-event/generic GUI semantic plans, saved-text scan
  filesystem mechanics, remaining browser AT-SPI/focused/privacy live probes,
  framed native-host byte IO, and remaining `pyatspi` runtime adapters.
